...
PYBIND11_MODULE(_core, m) {
  ...
  py::class_<EngineFacade>(m, "Engine")
      ...
      .def("shutdown", &EngineFacade::Shutdown, py::doc("shutdown() -> None"))
      ...
      .def("create_scene_with_object", &cpp_api::CreateSceneWithDefaultObject,
           ...
           py::doc("create_scene_with_object(scene_name: str, object_name: "
                   "str) -> tuple[Scene, GameObject]"))
      .def(
          "subscribe_event",
          ...
          py::doc(
              "subscribe_event(event_type: str, callback: Callable) -> int"))
      .def(
          "publish_event",
          [](EngineFacade &self, const std::string &event_type,
  ...
  py::class_<Scene, std::shared_ptr<Scene>>(m, "Scene")
      ...
      .def("find_objects_by_name", &cpp_api::FindObjectsByName, py::arg("name"),
      ...
      .def("batch_create_objects", &cpp_api::BatchCreateObjects,
           ...
           py::doc("batch_create_objects(count: int, prefix: str) -> "
                   "list[GameObject]"));
  ...
  py::class_<TransformComponent, Component>(m, "Transform")
      ...
      .def_property(
          "x", [](TransformComponent &t) -> float { return t.data.x; },
          [](TransformComponent &t, float v) { t.data.x = v; })
      .def_property(
          "y", [](TransformComponent &t) -> float { return t.data.y; },
          [](TransformComponent &t, float v) { t.data.y = v; })
      .def_property(
          "z", [](TransformComponent &t) -> float { return t.data.z; },
